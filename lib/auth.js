...
function authenticate(security, schemes, req, cfg) {
  ...
  if (!security || !security.length) {
    return { ok: true, auth: { scheme: null, token: null, claims: null, scopes: [], principal: null } };
  }
  schemes = schemes || {};
  ...
  return {
    ...
    auth: { scheme: null, token: null, claims: null, scopes: [], principal: null },
  };
}
